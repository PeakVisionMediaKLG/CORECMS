...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 14. Mrz 2022 um 17:30
...
INSERT INTO `app_pages` (`id`, `shared_identifier`, `language`, `url`, `link_text`, `title`, `show_in_navigation`, `auth_access_only`, `is_active`, `created_by`, `created_date`, `edited_by`, `edited_date`, `deleted_by`, `deleted_date`, `access_counter`) VALUES
(1, '8f61ff8a08d1be541d2a787f527a320c', 'de', 'subsub_de', 'Sub Sub DE', 'Sub Sub DE', 1, 0, 1, 'Admin', '1647006390', NULL, NULL, NULL, NULL, 0);
...
INSERT INTO `app_page_objects` (`id`, `shared_identifier`, `parent`, `name`, `object_type`, `excluded_languages`, `created_by`, `created_date`, `edited_by`, `edited_date`, `deleted_by`, `deleted_date`, `is_active`) VALUES
...
ALTER TABLE `app_page_objects`
  ...
  ADD UNIQUE KEY `shared_identifier` (`shared_identifier`);
