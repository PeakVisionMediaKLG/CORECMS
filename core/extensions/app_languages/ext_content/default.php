...
DOCUMENT::HEADER(array('title'=>'CORE '.$TXT['App languages'],'lang'=>'en_US','resources'=>array(),"DB"=>$DB,"CORE"=>$CORE));
        ...
        ROW::PRE(array('class'=>'g-0 px-5 m-0'));
            ...
            COLUMN::PRE(array('class'=>'col-12 text-center mb-4  text-nowrap'));
                ...
                if($delete_data)
                {
                BTN::PRE(array('class'=>'btn btn-outline-secondary core-modal-btn','title'=>$TXT['Restore language'],'caption'=>BI::GET(array('icon'=>'arrow-counterclockwise')),'data-path'=>$CORE->DOM_PATH."core/modals/modal.db.dataset.undelete/modal.php",
