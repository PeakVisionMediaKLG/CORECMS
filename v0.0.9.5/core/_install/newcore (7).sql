...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 15. Mrz 2022 um 18:04
...
INSERT INTO `app_assets` (`id`, `unique_identifier`, `name`, `src_file`, `src_db`, `eval`, `is_active`, `created_by`, `created_date`, `edited_by`, `edited_date`) VALUES
(1, 'un1', 'Bootstrap 5.1 CSS', '', '<!-- Bootstrap CSS -->\r\n    <link href=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/css/bootstrap.min.css\" rel=\"stylesheet\" integrity=\"sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3\" crossorigin=\"anonymous\">', 0, 1, '', '', '', ''),
(2, 'un2', 'Bootstrap 5.1 JS', '', '<!-- Option 1: Bootstrap Bundle with Popper -->    <script src=\"https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/dist/js/bootstrap.bundle.min.js\" integrity=\"sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p\" crossorigin=\"anonymous\"></script>', 0, 1, '', '', '', '');
...
INSERT INTO `app_languages` (`id`, `unique_identifier`, `name`, `code_2digit`, `code_5digit`, `short_caption`, `long_caption`, `is_active`, `created_by`, `created_date`, `edited_by`, `edited_date`) VALUES
(1, 'l1', 'english', 'en', 'en_US', 'EN', 'English', 1, '', '', '', ''),
(2, 'l2', 'deutsch', 'de', 'de_DE', 'DE', 'Deutsch', 0, '', '', '', '');
...
INSERT INTO `app_pages` (`id`, `unique_identifier`, `shared_identifier`, `language`, `url`, `link_text`, `title`, `show_in_navigation`, `auth_access_only`, `is_active`, `access_counter`, `created_by`, `created_date`, `edited_by`, `edited_date`) VALUES
(1, '', '8f61ff8a08d1be541d2a787f527a320c', 'de', 'subsub_de', 'Sub Sub DE', 'Sub Sub DE', 1, 0, 1, 0, 'Admin', '1647006390', NULL, NULL);
...
INSERT INTO `app_page_objects` (`id`, `unique_identifier`, `parent`, `name`, `object_type`, `excluded_languages`, `created_by`, `created_date`, `edited_by`, `edited_date`, `is_active`) VALUES
(0, '11d19bbeec19d2ba4ee556f818f19ac0', '', 'Home', 'page', '', 'Admin', '1647005905', '', '', 0),
(1, 'f94cb1ae17316984927376e7a3c063ab', '', 'top1', 'page', '', 'Admin', '1647006087', '', '', 0),
(2, '13a096aca73fde935efd22b938e4868f', '11d19bbeec19d2ba4ee556f818f19ac0', 'sub Home', 'page', '', 'Admin', '1647005932', '', '', 0),
(3, '8f61ff8a08d1be541d2a787f527a320c', '13a096aca73fde935efd22b938e4868f', 'subsub home', 'page', '', 'Admin', '1647006070', 'Admin', '1647006223', 1);
