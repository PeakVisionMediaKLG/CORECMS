...
echo"
<div class='alert alert-success' role='alert'>".$TXT['You have cut a <b>'].$type.$TXT["</b> element (ID:"].$id.$TXT[") branch to your clipboard."]." <a href='' class='core-cancel-copy'>".$TXT['Remove content from clipboard.']."</a></div>";    
