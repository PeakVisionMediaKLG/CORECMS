...
$ContentConfig['children']=array('container','row','card','text_image','fixed_aspect_image','image','carousel','carousel_columns','button','facebook_wall','background_video','custom'); //'navbar','language_menu','text_image','carousel','responsive_video','custom_content','background_video','image_aggregator'
...
'mykey'=>$ContentConfig['txt']['myvalue',
'mykey2'=>$ContentConfig['txt']['myvalue2',
);

$ContentConfig['customselects'][0]=array(
'mykeycs'=>$ContentConfig['txt']['myvaluex',
'mykey2cs'=>$ContentConfig['txt']['myvaluex2',
);


$ContentConfig['custominputs']=array(
'mylabel'=>$ContentConfig['txt']['myinput'
);
