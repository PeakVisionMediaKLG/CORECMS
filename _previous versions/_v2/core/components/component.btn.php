...
{		//class,href,style,disabled
		static function PRECODE($params=NULL,$data=NULL)
		{
			...
			$CODE = "<button type='button' class='".(new self)->WRITE_S($params,'class')."' ".(new self)->WRITE($params,'href')." ".(new self)->WRITE($params,'style')." ".(new self)->WRITE_DATA($data)." ".(new self)->WRITE_S($params,'disabled').">
