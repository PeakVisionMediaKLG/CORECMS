...
{
    $modalcontent = HIDDEN::PRINT_R(array('name'=>'dataset[id]','value'=>$data['condition'])).                    
...
$modal= new MODAL(array(
                        ...
                        'actionPath'=>"core/actions/action.be.user.update.php",
