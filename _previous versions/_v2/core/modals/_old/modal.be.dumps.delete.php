...
$modalContent="<p>".TXT['Are you sure you want to delete all backup files?']."</p><br>";

$dir = new DirectoryIterator(ROOT."backups/");
...
foreach ($dir as $fileinfo) {
    if (!$fileinfo->isDot()) {
        ...
        $modalContent.="<tr class='core-tablerow-std'><td class='p-2'><b>".TXT['Filename']."</b></td><td class='p-2'>".$fileinfo->getFilename()."</td></tr>";
        $modalContent.="<tr class='core-tablerow-std'><td class='p-2'><b>".TXT['Date']."</b></td><td class='p-2'>".date('d/M/Y H:i:s',explode("-",$fileinfo->getFilename())[3])."</td></tr>";
    ...
    $modalContent.=HIDDEN::PRINT_R(array('name'=>'file','value'=>'*'));
