        ...
        if(JQUERY_DEBUG_CONSOLE)
        {
            ...
            else 
            {
                ...
                .done(function(data){
                    ...
                    if(JQUERY_DEBUG_CONSOLE){console.log(data);}
                    if(JQUERY_DEBUG_PRINT)
                    {
                        
                        $.ajax({
                            type: "POST",url:'core/actions/session.set.value.php',
...
function coreModal(element)
    {	
        //getScrollPos();
        if(JQUERY_DEBUG_CONSOLE){console.log($(element).data());}
		$.ajax({ 
