...
CKEDITOR.editorConfig = function( config ) {
    ...
    config.filebrowserBrowseUrl = 'prerequisites/filemanager/filemanager/dialog.php?type=2&editor=ckeditor&fldr=';
	config.filebrowserUploadUrl = 'prerequisites/filemanager/filemanager/dialog.php?type=2&editor=ckeditor&fldr=';
	config.filebrowserImageBrowseUrl = 'prerequisites/filemanager/filemanager/dialog.php?type=1&editor=ckeditor&fldr=';
