...
?>   
<div class="row core-facebook-wall <?php $this->PREPARE("classes",$ContentBasics['cUID'],$ContentBasics['cAttrClass']); ?>" <?php echo $ContentBasics['cAttrId']; ?>>
<?php 
...
for($i=0;$i<$max_posts;$i++){ 
    ...
    {    
        ...
        case "status":
            ...
            {
                $style="background-image:linear-gradient(-45deg, ".@$ContentData['custominput'][7].", ".@$ContentData['custominput'][8]."); padding-bottom:".$ContentData['customselect'][0]."%; height:0;";
        ...
        case "video":
            ...
            if (strpos($feed_items[$i]['link'], 'youtu') !== false) { 
            ...
            } elseif (strpos($feed_items[$i]['link'], 'facebook') !== false) { 
                
                $style="width:100%; height:0; background-image: url('https://graph.facebook.com/".$feed_items[$i]['object_id']."/picture?type=large'); background-size: cover; background-repeat: no-repeat; background-position:center; padding-bottom:".$ContentData['customselect'][0]."%;";
                ...
                ?>
                <div class="core-facebook-tile" style="<?php echo $style; ?>">
                    <div class="core-video-play-overlay"> 
                        <div data-featherlight-iframe-src="core/content/facebook_wall/fbvid_ajax.php?url=<?php echo $feed_items[$i]['short_video_link'];?>" class="core-facebook-overlay core-fb-video-overlay" data-featherlight="iframe" data-featherlight-iframe-style="border:none;width:90vw; max-width:768px !important;" data-featherlight-iframe-scrolling="no"> <!--data-featherlight-iframe-allowfullscreen="true" -->
                            <div class="core-facebook-description text-right p-3">
                                <div class="core-facebook-profile-name">
                                <a href='https://fb.com/<?php echo $fb_page_id;?>' target='_blank'><?php echo $feed_items[$i]['page_name']; ?></a><br>shared a 
                                <?php if($feed_items[$i]['type']=="status"){
                                ...
                                <div class='fb-profile-message core-clickable-hand core-facebook-message'>
                                <a href="core/content/facebook_wall/fbvid_ajax.php?url=<?php echo $feed_items[$i]['short_video_link'];?>" data-featherlight="iframe" data-featherlight-iframe-style="width:90vw; max-width:768px !important;" data-featherlight-iframe-allowfullscreen="true" data-featherlight-iframe-style="border:none;" data-featherlight-iframe-scrolling="no">    
                                        <?php $shorter=strpos($feed_items[$i]['message'],"https"); 
                                        if($shorter!=FALSE) echo substr($feed_items[$i]['message'],0,$shorter); 
                                        else {if($feed_items[$i]['type']!="video") echo $feed_items[$i]['message'];} 
                                        if($feed_items[$i]['type']=="video") echo "<br>".$feed_items[$i]['description']." ";
            ...
            } elseif (strpos($feed_items[$i]['link'], 'instagram') !== false) {   
                $style="background-image:linear-gradient(-90deg, ".@$ContentData['custominput'][7].", ".@$ContentData['custominput'][8]."); padding-bottom:".$ContentData['customselect'][0]."%; height:0;";
...
<?php /*
                                switch ($video_type[$feed_items[$i]['link']])
                                {
                                    ...
                                    case "facebook":
                                        ...
                                        <!--<div class="fb-video text-center core-facebook-video" data-href="<?php echo $feed_items[$i]['short_video_link'];?>"  data-show-text="false" data-width="auto" data-show-captions="false" onload="coreresizevid();"></div>-->
