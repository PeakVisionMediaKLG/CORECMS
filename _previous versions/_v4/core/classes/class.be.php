						...
						ROW::PRE(array('class'=>'align-items-center core-be-menu-height'));
							...
							COLUMN::PRE(array('class'=>'col-auto'));
								...
								BTN::PRE(array(	'class'=>'btn btn-outline-primary core-action-btn',
										...
										array(	'data-path'=>'core/core/actions/session.toggle.value.php',
							...
							COLUMN::PRE(array('class'=>'col-auto'));
								...
								BTN::PRE(array(	'class'=>'btn btn-outline-secondary core-toggle-action-btn'." $beActive",
										 ...
										 array(	'data-elementtotoggle'=>'.core-be-page',
												'data-toggle'=>'button',
												'data-path'=>'core/core/actions/session.toggle.value.php',
				...
				COLUMN::PRE(array('class'=>'col-xs-12 col-md-4 col-lg-3 col-xxl-2 core-be-leftmenu'));
					ACCORDION::PRE(array('class'=>'core-be-accordion','id'=>'core-be-accordion'));
						...
						ACCORDION_ITEM::PRE(array('id'=>'core-be-page-dashboard',
											...
											array('data-path'=>'core/core/actions/session.toggle.value.php','data-thekey'=>'CORE.SHOWDASHBOARDAREA')
										);
						ACCORDION_ITEM::POST();	
						...
						ACCORDION_ITEM::PRE(array('id'=>'core-be-page-pages',
												...
												'show'=>$showPages,
												'buttonclass'=>'text-start core-action-btn-nr'),
											array('data-path'=>'core/core/actions/session.toggle.value.php','data-thekey'=>'CORE.SHOWPAGESAREA')
										);
						ACCORDION_ITEM::POST();	
						...
						ACCORDION_ITEM::PRE(array('id'=>'core-be-page-content',
												...
												'show'=>$showContent,
												'buttonclass'=>'text-start core-action-btn-nr'),
											array('data-path'=>'core/core/actions/session.toggle.value.php','data-thekey'=>'CORE.SHOWCONTENTAREA')
										);
						...
						ACCORDION_ITEM::PRE(array('id'=>'core-be-files',
												  ...
												  'show'=>$showFiles,
												  'buttonclass'=>'text-start core-action-btn-nr'),
											array('data-path'=>'core/core/actions/session.toggle.value.php','data-thekey'=>'CORE.SHOWFILESAREA')
										   );
						...
						ACCORDION_ITEM::PRE(array('id'=>'core-be-system',
													...
													'show'=>$showSystem,
													'buttonclass'=>'text-start core-action-btn-nr'),
												array('data-path'=>'core/core/actions/session.toggle.value.php','data-thekey'=>'CORE.SHOWSYSTEMAREA')
											);
						...
						if($this->USER->IS_ADMIN){
							...
							ACCORDION_ITEM::PRE(array('id'=>'core-be-database',
													...
													'show'=>$showDatabase,
													'buttonclass'=>'text-start core-action-btn-nr'),
														array('data-path'=>'core/core/actions/session.toggle.value.php','data-thekey'=>'CORE.SHOWDBAREA')
													);
							...
							ACCORDION_ITEM::PRE(array('id'=>'core-be-files',
													  ...
													  'show'=>$showTools,
													  'buttonclass'=>'text-start core-action-btn-nr'),
												array('data-path'=>'core/core/actions/session.toggle.value.php','data-thekey'=>'CORE.SHOWTOOLSAREA')
											   );
