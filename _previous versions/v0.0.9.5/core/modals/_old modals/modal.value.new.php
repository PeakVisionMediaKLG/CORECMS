		...
		foreach($BE->BELANGUAGES as $key => $value)
		{
			...
			TD::PRE_R(array('class'=>'')).
				TEXTBOX::PRINT_R(array(
					...
					//'label'=>TXT['Value'],
					'type'=>'text',
					'name'=>'coredata[0][caption_'.$value.']',
					//'id'=>'',
					//'tabindex'=>'60',
					'required'=>'required',
					//'value'=>'',
...
$modal= new CORE\MODAL(array(
                        ...
                        'actionPath'=>"core/actions/dataset.multiinsert.php",
