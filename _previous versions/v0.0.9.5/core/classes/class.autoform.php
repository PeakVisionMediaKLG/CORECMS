            ...
            switch ($inputSettings['input_type'])
            {
                    ...
                    if(!$inputSettings['hidden']){
                        if($inputSettings['show_in_form'])
                            {                            
                                ...
                                $formString .= "    <div class='col'><input type='text' class='form-control' id='$input' name='core_data__$input' value='".$dbData[$input]."'>";
                                $formString .= "</div></div>";
                            }
                    else $formString .= "<input type='hidden' name='core_data__$input' value='".$dbData[$input]."'>";
                    }
                break;
                ...
                case "CHECKBOX":
                    ...
                    $formString .= "<div class='row mt-2'><div class='col'>
                                    ...
                                    <div class='col'>
                                        <input class='form-check-input core-checkbox' type='checkbox' name='core_data__$input' value=".$dbData[$input]." id='$input' $checked>
                                    </div>  
                                    </div>";
                break;
                ...
                case "SELECT":
                    $dbData[$input] = $dbData[$input] ?? "";
                        ...
                        $formString .= "
                                    ...
                                    <div class='col'>
                                        <select class='form-select mb-1' name='core_data__$input'
